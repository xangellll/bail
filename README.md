...
await sock.sendMessage(jid, { 
    eventMessage: { 
        isCanceled: false, 
        name: "Hello World", 
        description: "xangel not dev", 
        location: { 
            degreesLatitude: 0, 
            degreesLongitude: 0, 
            name: "Vanegeta" 
        }, 
        joinLink: "https://call.whatsapp.com/video/aboutxangel", 
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/XangelXy",
                    merchant_url: "https://t.me/XangelXy"
                })
            }
        ]
    }
